...
class Company(Base):
    ...
    corporate_number = Column(String(13), unique=True, nullable=True, index=True, comment="法人番号 (個人事業主は任意)")
    business_category = Column(String, default="CORPORATION", comment="事業種別: CORPORATION, SOLE_PROPRIETOR")
    legal_name = Column(String, nullable=False, comment="正式商号 / 屋号・氏名")
    ...
    establishment_date = Column(Date, nullable=False, comment="設立年月日 / 開業年月日")
    capital_stock = Column(Float, nullable=False, default=0, comment="資本金 / 元入金（円）")
